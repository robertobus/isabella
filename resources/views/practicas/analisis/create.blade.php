    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="box box-default">
                {!! Form::open(array('method' => 'post', 'url' => url("analisis/guardar"))) !!}
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="form-group {{ $errors->has('paciente_id') ? 'has-error' : '' }}">
                                    ...
                                    {!! Form::select('paciente_id', $pacientes, '', ['class' => 'form-control select2']) !!}
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="form-group {{ $errors->has('medico_id') ? 'has-error' : '' }}">
                                    ...
                                    {!! Form::select('medico_id', $medicos, '', ['class' => 'form-control select2']) !!}
                            ...
                            <div class="col-lg-4">
                                <div class="form-group {{ $errors->has('obra_social_id') ? 'has-error' : '' }}">
                                    ...
                                    {!! Form::select('obra_social_id', $obras_sociales, '', ['class' => 'form-control']) !!}
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group {{ $errors->has('diagnostico') ? 'has-error' : '' }}">
                                    ...
                                    {!! Form::text('diagnostico', '', array('class' => 'form-control')) !!}
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group {{ $errors->has('grupo') ? 'has-error' : '' }}">
                                    ...
                                    {!! Form::select('grupo', ['' => 'Seleccione', 'A' => 'A', 'B' => 'B', 'AB' => 'AB', '0' => '0'], '', ['class' => 'form-control select_custom_highlight_red']) !!}
                                    @if ($errors->has('grupo'))
                                        <span class="help-block">
                                            <span class="glyphicon glyphicon-alert" aria-hidden="true"></span>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group {{ $errors->has('factor') ? 'has-error' : '' }}">
                                    ...
                                    {!! Form::select('factor', $options_pn, '', ['class' => 'form-control select_custom_highlight_red']) !!}
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group {{ $errors->has('pci') ? 'has-error' : '' }}">
                                    {!! Form::label('pci', 'PCI') !!}
                                    {!! Form::select('pci', $options_pn, '', ['class' => 'form-control select_custom_highlight_red']) !!}
                                    @if ($errors->has('pci'))
                                        <span class="help-block">
                                            <span class="glyphicon glyphicon-alert" aria-hidden="true"></span>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group {{ $errors->has('pcd') ? 'has-error' : '' }}">
                                    {!! Form::label('pcd', 'PCD') !!}
                                    {!! Form::select('pcd', $options_pn, '', ['class' => 'form-control select_custom_highlight_red']) !!}
                                    @if ($errors->has('pcd'))
                                        <span class="help-block">
                                            <span class="glyphicon glyphicon-alert" aria-hidden="true"></span>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group {{ $errors->has('ppt') ? 'has-error' : '' }}">
                                    {!! Form::label('ppt', 'PPT') !!}
                                    {!! Form::select('ppt', $options_pn, '', ['class' => 'form-control select_custom_highlight_red']) !!}
                                    @if ($errors->has('ppt'))
                                        <span class="help-block">
                                            <span class="glyphicon glyphicon-alert" aria-hidden="true"></span>
