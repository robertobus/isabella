<head>
    <meta charset="UTF-8">
    <title> AdminLTE 2 with Laravel - @yield('htmlheader_title', 'Isabella - SIGH') </title>
    ...
    @section('styles')
        ...
        <link href="{{ asset('adminlte/bootstrap/css/font-awesome.min.css') }}" rel="stylesheet" type="text/css" />
